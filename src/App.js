  ...
  return (
    <div className="App">
      <h1>Hello Redux Basic</h1>
      {
        ...
        <>
          <div className="counter">Counter: {handleNegative(globalState.counter)}</div>
          <div>
            <button id="increase" onClick={()=>counterHandler("increase",1)}>increase +</button>
            <button id="decrease" onClick={()=>counterHandler("decrease",-1)}>decrease -</button>
          </div>
        </>
      }
      <div>
